...
[]: # Path: src/0-9/index.md

# 0-9

- [0x](/src/0-9/0x.md) : 0x est une plateforme de trading de token sur blockchain Ethereum. Elle permet à tout utilisateur de créer sa propre plateforme de trading de token en quelques clics. Elle permet également de créer des tokens et de les lister sur sa plate
